...
public class FormNhan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 130, -1));

        jLabel2.setText("Số thứ 2:");
        jLabel2.setMaximumSize(new java.awt.Dimension(55, 16));
        jLabel2.setMinimumSize(new java.awt.Dimension(55, 16));
        jLabel2.setPreferredSize(new java.awt.Dimension(55, 16));
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, -1, -1));

        jLabel3.setText("Số thứ 1:");
        jLabel3.setMaximumSize(new java.awt.Dimension(61, 16));
        jLabel3.setMinimumSize(new java.awt.Dimension(61, 16));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            lblKQ.setText(so_1 +" * " + so_2 +" = "+ (so_1 * so_2));
        } catch (Exception e) {
