...
Object[] rowData = {vehicle, fromLocation, toLocation, totalPrice};
yourTableModel.addRow(rowData);

// Hiển thị frame mới
xuat outputFrame = new xuat();
outputFrame.addDataToTable(vehicle, fromLocation, toLocation, ticketQuantity);
